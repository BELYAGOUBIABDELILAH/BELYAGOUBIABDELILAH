...
**MSc in Networks, Systems & Information Security — Djilali Liabes University.**

I started in cybersecurity and AI research. Now I ship products.
Full-stack platforms, ML models, data pipelines, security-aware systems —
I work across the stack and take things from idea to production.

</div>

- **Researching** — Federated Learning · ML for Healthcare · Deep Learning
- **Background** — Cryptography · Ensemble Methods · Statistical Inference · R · Weka · Java
- **Open to** — Full-stack, data, AI/ML roles · Research collaborations · Open source

---

## Featured Projects

**[CityHealth](https://github.com/BELYAGOUBIABDELILAH/Cityhealth)** — Real-time digital health platform. Doctors, pharmacies on duty, emergency services & blood donors. Web · PWA · Browser Extension · MCP · API.  MSc thesis. `TypeScript` `React` `Supabase`
...
Also building — [Academic Paper Replications](https://github.com/BELYAGOUBIABDELILAH/academic-paper-replications) · [AI/ML Healthcare Models](https://github.com/BELYAGOUBIABDELILAH/AI-ML-PROJECTS) · [BPStartdz](https://github.com/BELYAGOUBIABDELILAH/BPStartdz) · [30 Days of DA](https://github.com/BELYAGOUBIABDELILAH/30-days-of-data-analyst)
...
![Weka](https://img.shields.io/badge/Weka-8B0000?style=flat-square&logoColor=white)
...
![MCP](https://img.shields.io/badge/Anthropic_MCP-000000?style=flat-square&logo=anthropic&logoColor=white)
...
*Started with cybersecurity research. Now shipping products.*
